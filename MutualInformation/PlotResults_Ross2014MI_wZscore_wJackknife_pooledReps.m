...
% 'CombinatorialSignalingMacrophages_p38NFkB\MutualInformation\MutualInformationOutputs'
...
%% Figure 2 Mutual Information in Mock vs Ligand P38 only
...
%% Figure 3 Mutual Information in All 4 Ligands Dose 6 p38 only, NFkBonly and Both
...
%% Figure 3 Mutual Information in Mock vs Ligand p38 only, NFkBonly, Both
% Load output file from HERE:
%this repository
% 'CombinatorialSignalingMacrophages_p38NFkB\MutualInformation\MutualInformationOutputs'
...
%% Figure 4 Mutual Information in 3 PAMPs Dose 6 p38 only, NFkBonly, and Both dynamics
...
%% Figure 5 Mutual Information in 4x Ligand Dose responses p38 only. NFkBonly, and Both dynamics, incl Mock (6 doses)
