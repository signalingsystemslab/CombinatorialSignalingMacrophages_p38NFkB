% Obtained from Ross 2014 https://doi.org/10.1371/journal.pone.0087357
...
% SL: Here d is our stimulus/dose labels for each cell  (1 X n_labels), and c is our dynamic feature matrix that (n_features by n_cells)
